#ifndef SusySkimHiggsino_twoleptonSelector_H
#define SusySkimHiggsino_twoleptonSelector_H

//RootCore
#include "SusySkimMaker/BaseUser.h"

class twoleptonSelector : public BaseUser
{
...
static const BaseUser* twoleptonSelector_instance __attribute__((used)) = new twoleptonSelector();
