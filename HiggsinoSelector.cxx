...
// ------------------------------------------------------------------------------------------ //
int HiggsinoSelector::getHiggsinoDM(int DSID){
  int deltaM = 0;
...
// ------------------------------------------------------------------------------------------ //
bool HiggsinoSelector::isHiggsinoN2C1p(int DSID){
  bool isN2C1p = false;
...
// ------------------------------------------------------------------------------------------ //
bool HiggsinoSelector::isHiggsinoN2C1m(int DSID){
  bool isN2C1m = false;
...
// ------------------------------------------------------------------------------------------ //
bool HiggsinoSelector::isHiggsinoC1C1(int DSID){
  bool isC1C1 = false;
...
// ------------------------------------------------------------------------------------------ //
bool HiggsinoSelector::isHiggsinoN2N1(int DSID){
  bool isN2N1 = false;
...
// ------------------------------------------------------------------------------------------ //
double HiggsinoSelector::getWinoBinoFuncMllDistr(double x, double *par){
...
// ------------------------------------------------------------------------------------------ //
double HiggsinoSelector::getWinoBinoMllWeight(int DSID, double mass){
  // See https://its.cern.ch/jira/browse/HIGGSINO-27:
...
// ------------------------------------------------------------------------------------------ //
double HiggsinoSelector::getWinoBinoXsecWeight(int DSID){
...
// ------------------------------------------------------------------------------------------ //
double HiggsinoSelector::getWinoBinoBrFracWeight(int DSID){
  // See https://its.cern.ch/jira/browse/HIGGSINO-27:
...
// ------------------------------------------------------------------------------------------ //
void HiggsinoSelector::emulateL1TopoTriggers(ConfigMgr*& configMgr){
